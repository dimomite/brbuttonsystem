...
flash: $(BUILD_DIR)/$(TARGET).elf
	"c:/Installs/xpack-openocd-0.10.0-15/bin/openocd.exe" -f ./openocd.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"

#######################################
# erase
#######################################
erase: $(BUILD_DIR)/$(TARGET).elf
	"c:/Installs/xpack-openocd-0.10.0-15/bin/openocd.exe" -f ./openocd.cfg -c "init; reset halt;  mass_erase 0; exit"
