...
flash: $(BUILD_DIR)/$(TARGET).elf
	c:\Installs\xpack-openocd-0.10.0-14\bin\openocd.exe -f interface/stlink.cfg  -f target/stm32f1x.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"

#######################################
# erase
#######################################
erase: $(BUILD_DIR)/$(TARGET).elf
	c:\Installs\xpack-openocd-0.10.0-14\bin\openocd.exe -f interface/stlink.cfg -f target/stm32f1x.cfg -c "init; reset halt; stm32f1x mass_erase 0; exit"
